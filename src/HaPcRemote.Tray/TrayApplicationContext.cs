...
internal sealed class TrayApplicationContext : ApplicationContext
{
    ...
    public TrayApplicationContext()
    {
        ...
        {
            Icon = LoadAppIcon(),
            Text = $"HA PC Remote {GetVersionString()}",
            Visible = true,
        ...
        _ = Task.Run(async () =>
        {
            ...
            _notifyIcon.ContextMenuStrip!.BeginInvoke(async () => await CheckForUpdateAsync());
        });

        _logger.LogInformation("HA PC Remote Tray {Version} started", GetVersionString());
    }

    private ContextMenuStrip BuildContextMenu()
    {
        var menu = new ContextMenuStrip();
        menu.Items.Add($"HA PC Remote {GetVersionString()}", null, null!).Enabled = false;
    ...
    private async Task CheckForUpdateAsync()
    {
        ...
        _updateMenuItem.Click -= OnUpdateClick; // avoid stacking handlers
        ...
        async void OnUpdateClick(object? s, EventArgs a)
        {
            ...
            {
                // Installer will kill us and restart
                Application.Exit();
            }
            else
            {
